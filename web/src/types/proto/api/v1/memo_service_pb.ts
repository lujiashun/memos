...
/**
 * @generated from message memos.api.v1.GetDailyReviewRequest
 */
export type GetDailyReviewRequest = Message<"memos.api.v1.GetDailyReviewRequest"> & {
  /**
...
/**
 * Describes the message memos.api.v1.GetDailyReviewRequest.
 * Use `create(GetDailyReviewRequestSchema)` to create a new message.
 */
export const GetDailyReviewRequestSchema: GenMessage<GetDailyReviewRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 23);

/**
 * @generated from message memos.api.v1.GetDailyReviewResponse
 */
export type GetDailyReviewResponse = Message<"memos.api.v1.GetDailyReviewResponse"> & {
  /**
...
/**
 * Describes the message memos.api.v1.GetDailyReviewResponse.
 * Use `create(GetDailyReviewResponseSchema)` to create a new message.
 */
export const GetDailyReviewResponseSchema: GenMessage<GetDailyReviewResponse> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 24);

/**
 * @generated from message memos.api.v1.GetMemoInsightRequest
 */
export type GetMemoInsightRequest = Message<"memos.api.v1.GetMemoInsightRequest"> & {
  /**
   * Optional. Filter to apply to the list results.
   * Filter is a CEL expression to filter memos.
   *
...
/**
 * Describes the message memos.api.v1.GetMemoInsightRequest.
 * Use `create(GetMemoInsightRequestSchema)` to create a new message.
 */
export const GetMemoInsightRequestSchema: GenMessage<GetMemoInsightRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 25);

/**
 * @generated from message memos.api.v1.GetMemoInsightResponse
 */
export type GetMemoInsightResponse = Message<"memos.api.v1.GetMemoInsightResponse"> & {
  /**
   * @generated from field: string content = 1;
   */
  content: string;
...
/**
 * Describes the message memos.api.v1.GetMemoInsightResponse.
 * Use `create(GetMemoInsightResponseSchema)` to create a new message.
 */
export const GetMemoInsightResponseSchema: GenMessage<GetMemoInsightResponse> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 26);

/**
 * Request for text refinement.
 *
 * @generated from message memos.api.v1.TextRefineRequest
 */
export type TextRefineRequest = Message<"memos.api.v1.TextRefineRequest"> & {
  /**
...
/**
 * Describes the message memos.api.v1.TextRefineRequest.
 * Use `create(TextRefineRequestSchema)` to create a new message.
 */
export const TextRefineRequestSchema: GenMessage<TextRefineRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 27);

/**
 * Response for text refinement.
 *
 * @generated from message memos.api.v1.TextRefineResponse
 */
export type TextRefineResponse = Message<"memos.api.v1.TextRefineResponse"> & {
  /**
...
/**
 * Describes the message memos.api.v1.TextRefineResponse.
 * Use `create(TextRefineResponseSchema)` to create a new message.
 */
export const TextRefineResponseSchema: GenMessage<TextRefineResponse> = /*@__PURE__*/
...
export const MemoService: GenService<{
   ...
   *
   * @generated from rpc memos.api.v1.MemoService.GetDailyReview
   */
  getDailyReview: {
    methodKind: "unary";
    input: typeof GetDailyReviewRequestSchema;
    output: typeof GetDailyReviewResponseSchema;
  },
  /**
   * GetMemoInsight generates a insight for the requested memos.
   *
   * @generated from rpc memos.api.v1.MemoService.GetMemoInsight
   */
  getMemoInsight: {
    methodKind: "unary";
    input: typeof GetMemoInsightRequestSchema;
    output: typeof GetMemoInsightResponseSchema;
  },
  /**
   * TextRefine refines input text with a prompt.
   *
   * @generated from rpc memos.api.v1.MemoService.TextRefine
   */
  textRefine: {
    methodKind: "unary";
    input: typeof TextRefineRequestSchema;
    output: typeof TextRefineResponseSchema;
  },
}> = /*@__PURE__*/
