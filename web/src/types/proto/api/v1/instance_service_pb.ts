...
export const file_api_v1_instance_service: GenFile = /*@__PURE__*/
  fileDesc("", [file_api_v1_user_service, file_google_api_annotations, file_google_api_client, file_google_api_field_behavior, file_google_api_resource, file_google_protobuf_field_mask]);
...
export type InstanceSetting = Message<"memos.api.v1.InstanceSetting"> & {
  ...
  value: {
    ...
    /**
     * @generated from field: memos.api.v1.InstanceSetting.OpenAISetting openai_setting = 5;
     */
    value: InstanceSetting_OpenAISetting;
    case: "openaiSetting";
  } | {
    /**
     * @generated from field: memos.api.v1.InstanceSetting.SmsSetting sms_setting = 6;
     */
    value: InstanceSetting_SmsSetting;
    case: "smsSetting";
 ...
 *
 * @generated from message memos.api.v1.InstanceSetting.OpenAISetting
 */
export type InstanceSetting_OpenAISetting = Message<"memos.api.v1.InstanceSetting.OpenAISetting"> & {
  /**
...
/**
 * Describes the message memos.api.v1.InstanceSetting.OpenAISetting.
 * Use `create(InstanceSetting_OpenAISettingSchema)` to create a new message.
 */
export const InstanceSetting_OpenAISettingSchema: GenMessage<InstanceSetting_OpenAISetting> = /*@__PURE__*/
  messageDesc(file_api_v1_instance_service, 2, 3);

/**
 * SMS related instance settings.
 *
 * @generated from message memos.api.v1.InstanceSetting.SmsSetting
 */
export type InstanceSetting_SmsSetting = Message<"memos.api.v1.InstanceSetting.SmsSetting"> & {
  /**
   * verification_method is the verification method to use.
   * Possible values: phone, sms
   *
   * @generated from field: string verification_method = 1;
   */
...
/**
 * Describes the message memos.api.v1.InstanceSetting.SmsSetting.
 * Use `create(InstanceSetting_SmsSettingSchema)` to create a new message.
 */
export const InstanceSetting_SmsSettingSchema: GenMessage<InstanceSetting_SmsSetting> = /*@__PURE__*/
...
export enum InstanceSetting_Key {
   ...
   *
   * @generated from enum value: OPENAI = 4;
   */
  OPENAI = 4,
