...
const file_store_instance_setting_proto_rawDesc = "" +
	"\n" +
	"\x1cstore/instance_setting.proto\x12\vmemos.store\"\xe1\x03\n" +
	...
	"\x0eopenai_setting\x18\x06 \x01(\v2\".memos.store.InstanceOpenAISettingH\x00R\ropenaiSettingB\a\n" +
	"\x05value\"\\\n" +
